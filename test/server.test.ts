...
describe("MCP server", () => {
  it("advertises the three Solana tools", async () => {
    ...
    expect(tools.tools.map((tool) => tool.name).sort()).toEqual([
      "evm_get_address", "evm_get_address_transactions", "evm_get_contract", "evm_get_contract_info", "evm_get_token", "evm_get_transaction", "evm_list_chains", "evm_trace_transaction",
